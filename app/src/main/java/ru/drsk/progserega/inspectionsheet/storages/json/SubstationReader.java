...
public class SubstationReader {
    ...
    public GeoSubstationsResponse readSubstations(InputStream is) throws IOException {
        ...
        Gson gson = new Gson();
        GeoSubstationsResponse response = gson.fromJson(jsonString, GeoSubstationsResponse.class);
        return response;
    }
}
